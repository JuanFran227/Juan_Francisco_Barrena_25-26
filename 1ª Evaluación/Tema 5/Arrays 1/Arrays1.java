...
public class Arrays1 {
    ...
    public static void Ejercicio9() {
        ...
        int[] arraydesordenado = {3, 5, 1, 6, 2, 9, 4, 3, 6, 7, 2, 9, 4};
        ...
        for(int i = 0; i < arraydesordenado.length; i++){
            for(int j = 0; j < arraydesordenado.length -1 -i; j++){
                if (arraydesordenado[j] > arraydesordenado[j + 1]){
                    ...
                    int orden = arraydesordenado[j];
                    arraydesordenado[j] = arraydesordenado[j + 1];
                    arraydesordenado[j + 1] = orden;
                } 
            }
        }
    ...
    public static void Ejercicio10() {
        ...
        for (int i = 0; i < 20; i++) {
            int numeroaleatorio = rm.nextInt(50) + 1;
    ...
    public static void Ejercicio16() {
        ...
        do {
            ...
            System.out.println("¿Quiere introducir un valor S/N? ");
     ...
     * a empezar.
     */
    public static boolean posicionValida(int oldX, int oldY, int newX, int newY){
        ...
        if (newX == oldX || newY == oldY || oldX+oldY == newX+newY || oldX-oldY == newX-newY) {
            valida = true;
        }
        return valida;
    }
    ...
    public static void Ejercicio17() {
        ...
        int DamaX = rd.nextInt(8);
        int DamaY = rd.nextInt(8);
        ...
        do {
            ...
            System.out.println("Introduzca la coordenada y: ");
            int y = sc.nextInt();
            if (posicionValida(DamaX, DamaY, x, y)) {
                pintarTablero(tablero);
                tablero[x][y] = '۩';
                DamaX=x;
                DamaY=y;
